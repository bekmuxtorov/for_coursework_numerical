...
class BasicVektorInputForm(forms.Form):
    basic_item_0 = forms.FloatField(
        required=True, widget=forms.NumberInput(attrs={'placeholder': 'Y00'}))
    basic_item_1 = forms.FloatField(
        required=True, widget=forms.NumberInput(attrs={'placeholder': 'Y01'}))
    basic_item_2 = forms.FloatField(
        required=True, widget=forms.NumberInput(attrs={'placeholder': 'Y02'}))
    basic_item_3 = forms.FloatField(
        required=True, widget=forms.NumberInput(attrs={'placeholder': 'Y03'}))
